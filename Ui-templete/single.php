          ...
          <div class="row">
           ...
           <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="#">
              <img src="assets/images/favicon/favicon.png" alt="" width="50">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a href="" class="nav-link btn-login"> register</a>
                    </li>

                    <li class="nav-item">
                        <a href="" class="nav-link btn-login">Log In</a> 
                    </li>
                  </div>
                </li>
              </ul>
                ...
                <div class="col-md-12">
                    ...
                    <nav class="page-breadcrumb-item">
                        <ol>
                            ...
                            <!-- Active Breadcrumb -->
                            <li><a href=""> single page <i class="fa fa-angle-double-right"></i></a></li>
                        </ol>
                    </nav>
                ...
                <div class="col-md-8">
                    ...
                    <div class="blog-single">
                        ...
                        <div class="blog-banner">
                            <img src="admin/dist/post-image/avatar.png">
                        </div>
                            ...
                            <div class="blog-description-quote">
                                <p><i class="fa fa-quote-left"></i>In publishing &graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface without relying on meaningful content. Lorem ipsum may be used as a placeholder before final <i class="fa fa-quote-right"></i></p>
                            </div>
                                        ...
                                        <div class="comment-box">      
                                            <div class="comment-box-header">
                                                <ul>
                                                    ...
                                                    <li class="post-by-hour">2 days ago</li>
                                                </ul>
                                            </div>
                                            <p>Hello There !</p>
                                        </div>
                            ...
                            <div class="recent-post-item">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-8 no-padding">
                                        ...
                                        <ul>
                                            <li>
                                                <i class="fa fa-clock-o"></i>2023-02-09
                                            </li>
                                        </ul>
                                    </div>      
                                </div>
                                ...
                                <div class="recent-comments-item">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 no-padding">
                                            ...
                                            <ul>
                                                <li>
                                                    <i class="fa fa-user-o"></i> Nazmul Hassan
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
